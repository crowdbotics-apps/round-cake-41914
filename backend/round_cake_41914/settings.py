"""
Django settings for round_cake_41914 project.
...
ROOT_URLCONF = 'round_cake_41914.urls'
...
WSGI_APPLICATION = 'round_cake_41914.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "round_cake_41914 API",
    "DESCRIPTION": "API documentation for round_cake_41914 App",
    "VERSION": "v1",
}
